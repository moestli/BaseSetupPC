...
Try {
	...
	[string]$appVendor = 'Magnus Oestli'
	[string]$appName = 'Personal Computer Setup'
	...
	[string]$appScriptAuthor = 'Magnus Oestli'
	##*===============================================
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		## Show Welcome Message and prompt to close open applications
		Show-InstallationWelcome -CloseApps $CloseApps
